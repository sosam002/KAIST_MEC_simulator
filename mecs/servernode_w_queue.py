...
class ServerNode(Node):
    ...
    def offloaded_tasks(self, tasks, arrival_timestamp):
        ...
        for task_id, task_ob in tasks.items():
            ...
            failed_to_offload += (not self.queue_list[task_ob.application_type].arrived(task_ob))
            self.queue_list[task_ob.application_type].arrived(task_ob)
        ...
        for app_type, population in app_type_pop:
            if app_type in this_app_type_list:
                ...
                if data_size >0:
                    ...
                    failed_to_generate += (not self.queue_list[app_type].arrived(t))
