...
class RandomDirection(StochasticWalk):
    def __init__(self, nr_nodes, dimensions, wt_max=None, velocity=(0.1, 1.), border_policy='reflect'):
        ...
        StochasticWalk.__init__(self, nr_nodes, dimensions, FL_DISTR, VELOCITY_DISTR, WT_DISTR=WT_DISTR,
                                border_policy=border_policy)


class TruncatedLevyWalk(StochasticWalk):
    def __init__(self, nr_nodes, dimensions, FL_EXP=-2.6, FL_MAX=50., WT_EXP=-1.8, WT_MAX=100.,
...
class HeterogeneousTruncatedLevyWalk(StochasticWalk):
    def __init__(self, nr_nodes, dimensions, WT_EXP=-1.8, WT_MAX=100., FL_EXP=-2.6, FL_MAX=50.,
                 border_policy='reflect'):
        '''
