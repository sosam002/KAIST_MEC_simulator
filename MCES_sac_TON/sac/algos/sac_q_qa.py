...
# from .base_step8 import RLAlgorithm
from .base_q_qa import RLAlgorithm


class SAC_q_qa(RLAlgorithm, Serializable):
    ...
    def __init__(
        ...
        super(SAC_q_qa, self).__init__(**base_kwargs)
    ...
    def _init_training(self, env, policy, pool):
        super(SAC_q_qa, self)._init_training(env, policy, pool)
