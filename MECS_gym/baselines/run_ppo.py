...
from baselines.common.vec_env.vec_normalize import VecNormalize, VecNormalizeEval
...
def common_arg_parser():
    ...
    parser.add_argument('--fixstd', help='use Eval Env', type=int, default=0)
    parser.add_argument('--logstd_init', help='use Eval Env', type=int, default=0)
    parser.add_argument('--cost_type', help='use Eval Env', type=int, default=20)
    parser.add_argument('--seed', help='RNG seed', type=int, default=0)
    parser.add_argument('--alg', help='Algorithm', type=str, default='ppo3')
    parser.add_argument('--num_timesteps', type=float, default=5e8),
...
def main():
    ...
    register(
        id='MECS-v4',
        entry_point='baselines.env_V_sweep_v4:MEC_v4',
        max_episode_steps=5000,
    )
    register(
        id='MECS-v5',
        entry_point='baselines.env_V_sweep_v5:MEC_v5',
        max_episode_steps=5000,
    )
    register(
        id='MECS-v6',
        entry_point='baselines.env_V_sweep_v6:MEC_v6',
        max_episode_steps=5000,
    )
    register(
        id='MECS-v7',
        entry_point='baselines.env_V_sweep_v7_new:MEC_v7',
        max_episode_steps=5000,
    )

    register(
        id='MECS-v8',
        entry_point='baselines.env_V_sweep_v8_new:MEC_v8',
        max_episode_steps=5000,
    )
    register(
        id='MECS-v9',
        entry_point='baselines.env_V_sweep_v9:MEC_v9',
        max_episode_steps=5000,
    )
