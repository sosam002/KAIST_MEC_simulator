...
class Model(object):
    ...
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train,
        ...
        def train(lr, cliprange, klconst, obs, returns, advs, masks, actions, values, neglogpacs, mean_now, logstd_now, kl_rest, states=None):
    ...
    for update in range(1, nupdates+1):
        ...
        for _ in range(noptepochs):
            ...
            for _ in range(int(nsteps/nbatch_train)):
                ...
                slices = (arr[idx] for arr in (runner.obfilt(seg["ob"]), ret, gae, seg["done"], seg["ac"], values[:-1], seg["neglogp"], seg["mean"], seg["logstd"], kl_rest))
