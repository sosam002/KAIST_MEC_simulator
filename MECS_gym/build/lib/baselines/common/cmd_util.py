...
def common_arg_parser():
    ...
    Mujoco_Envs = ['HalfCheetah-v1', 'Hopper-v1',
                   'Walker2d-v1', 'Humanoid-v1', 'Ant-v1', 'Humanoid(rllab)','BipedalWalker-v2',
    ...
    parser = arg_parser()
    parser.add_argument('--envn', help='environment ID', type=int, default=4)
    ...
    parser.add_argument('--num_repeat', help='Repeat Number', type=float, default=1)
    parser.add_argument('--vtrace', help='use V-trace adv', type=bool, default=False)
    ...
    log_dir = './ppo2result/%s_leng%d_clip%.1f'%(args.alg, args.leng,args.eps)
    if args.vtrace:
        log_dir+='_vtrace'
