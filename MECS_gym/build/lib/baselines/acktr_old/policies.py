...
from baselines.acktr_old.utils import dense, kl_div
...
class GaussianMlpPolicy(object):
    def __init__(self, ob_dim, ac_dim):
        ...
        self._evalact = U.function([ob_no],[eval_ac_na])  # Generate a new action and its logprob
