...
def common_arg_parser():
    ...
    Mujoco_Envs = ['HalfCheetah-v1', 'Hopper-v1',
                   'Walker2d-v1', 'Ant-v1', 'Humanoid-v1', 'HumanoidStandup-v1', 'BipedalWalker-v2',
                   'BipedalWalkerHardcore-v2', 'Humanoid(rllab)', 'Swimmer-v1', 'Pendulum-v0', 'Reacher-v1', 'InvertedDoublePendulum-v1', 'InvertedPendulum-v1',]
