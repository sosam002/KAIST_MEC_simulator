...
class MEC_v1(gym.Env):
    ...
    def _step_alpha(self, action):
        ...
        #     print("a_1 time : ",t2-t1)
        #     print("a_2 time : ",t3-t2)
        #     print("a_3 time : ",t4-t3)
    ...
    def _step_beta(self, action):
        ...
        #     print("b_1 time : ",t2-t1)
        #     print("b_2 time : ",t3-t2)
        #     print("b_3 time : ",t4-t3)
    ...
    def get_cost(self, used_edge_cpus, used_cloud_cpus, before, after, failed_to_offload=0, failed_to_generate=0):
        ...
        return (edge_drift_cost+self.cost_type*(edge_computation_cost+cloud_payment_cost-0.0001))/100
