...
from baselines.common.vec_env.vec_normalize import VecNormalizeEval
def arg_parser():
    """
...
def common_arg_parser():
    ...
    parser.add_argument('--evalenv', help='use Eval Env', type=int, default=0)
    parser.add_argument('--seed', help='RNG seed', type=int, default=0)
    parser.add_argument('--alg', help='Algorithm', type=str, default='trpo_mpi')
    ...
    log_dir = '/home/wisrl/Downloads/log_ppo/Mujoco/%s'%(args.alg)
