...
def common_arg_parser():
    ...
    # log_dir = './result/%s_leng%d_clip%s'%(args.alg, args.leng, str(args.eps))
    if args.vtrace==1:
        log_dir+='_vtr'
    elif args.vtrace==4:
    ...
    if args.constlr:
        log_dir += '_constlr'
    if (args.alg=='ppo2_AMBER') or (args.alg=='ppo2_AMBER4_clipdim2') or (args.alg=='ppo2_AMBER5_clipdim2') or (args.alg=='ppo2_AMBER5_clipdim2_multiact')  :
        log_dir += '_clipcut%s'%(str(args.epscut))
    log_dir += '_minlr0.0001_numt5e6ant'
