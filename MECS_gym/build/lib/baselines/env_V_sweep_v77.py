...
class MEC_v77(gym.Env):
    def __init__(self, task_rate=10, applications=(SPEECH_RECOGNITION, NLP, FACE_RECOGNITION), time_delta=1, use_beta=True, empty_reward=True, cost_type=COST_TYPE, max_episode_steps=20000, time_stamp=0):
        super().__init__()
    ...
    def step(self, action, use_beta=True, generate=True):
        ...
        cost = self.get_cost(used_edge_cpus, used_cloud_cpus, q0, q_last, cost_type=self.cost_type)
