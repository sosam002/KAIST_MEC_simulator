...
def common_arg_parser():
    ...
    parser = arg_parser()
    parser.add_argument('--envn', help='environment ID', type=int, default=1)
    ...
    parser.add_argument('--logstd_init', help='use Eval Env', type=float, default=2)
